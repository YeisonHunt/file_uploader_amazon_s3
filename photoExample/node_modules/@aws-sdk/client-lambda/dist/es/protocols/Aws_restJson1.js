    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                body = JSON.stringify(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.BatchSize !== undefined && input.BatchSize !== null && { BatchSize: input.BatchSize })), (input.BisectBatchOnFunctionError !== undefined &&
                    ...
                    input.EventSourceArn !== null && { EventSourceArn: input.EventSourceArn })), (input.FunctionName !== undefined && input.FunctionName !== null && { FunctionName: input.FunctionName })), (input.MaximumBatchingWindowInSeconds !== undefined &&
                    ...
                    input.Queues !== null && { Queues: serializeAws_restJson1Queues(input.Queues, context) })), (input.SourceAccessConfigurations !== undefined &&
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                body = JSON.stringify(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.BatchSize !== undefined && input.BatchSize !== null && { BatchSize: input.BatchSize })), (input.BisectBatchOnFunctionError !== undefined &&
                    input.BisectBatchOnFunctionError !== null && { BisectBatchOnFunctionError: input.BisectBatchOnFunctionError })), (input.DestinationConfig !== undefined &&
                    input.DestinationConfig !== null && {
                    DestinationConfig: serializeAws_restJson1DestinationConfig(input.DestinationConfig, context),
                })), (input.Enabled !== undefined && input.Enabled !== null && { Enabled: input.Enabled })), (input.FunctionName !== undefined && input.FunctionName !== null && { FunctionName: input.FunctionName })), (input.MaximumBatchingWindowInSeconds !== undefined &&
                    input.MaximumBatchingWindowInSeconds !== null && {
                    MaximumBatchingWindowInSeconds: input.MaximumBatchingWindowInSeconds,
                })), (input.MaximumRecordAgeInSeconds !== undefined &&
                    input.MaximumRecordAgeInSeconds !== null && { MaximumRecordAgeInSeconds: input.MaximumRecordAgeInSeconds })), (input.MaximumRetryAttempts !== undefined &&
